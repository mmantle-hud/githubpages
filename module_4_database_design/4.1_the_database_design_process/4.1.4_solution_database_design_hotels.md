...
erDiagram
    ...
    hotels {
        INT hotel_id PK
        TEXT hotel_name "NOT NULL"
        DECIMAL price  "NOT NULL"
        INT star_rating "NOT NULL"
        DECIMAL distance_to_centre_kms "NOT NULL"
        INT style_id FK "NOT NULL"
    }
    styles{
        INT style_id PK
        TEXT style_name "NOT NULL"
    }
    amenities {
        INT amenity_id PK
        TEXT amenity_name "NOT NULL"
        TEXT amenity_description "NOT NULL"
