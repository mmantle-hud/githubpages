...
There are lots of different ways in which we can create ERDs. Feel free to choose any suitable tools of your choosing. The two main approaches I would recommend are as follows. 

### 1. Code-Based Tools
All the notes on this course have been written using a simple language called Markdown. The diagrams have been created using with Mermaid.js. For example, here's the code used to create the conceptual ERD shown above.
...
- Mermaid.js
  - Mermaid.js is a general purpose diagramming tool. it can be used to create many different types of diagram. For documentation on creating ERDs see [https://mermaid.ai/open-source/syntax/entityRelationshipDiagram.html](https://mermaid.ai/open-source/syntax/entityRelationshipDiagram.html).
...
These work like a tools such as PowerPoint. We drag boxes and lines onto a canvas, add text and link elements together to build up diagrams. They have the advantage of being a little easier to work with initially. However, it can be time-consuming to create larger more complex diagrams. There are many online editors. They tend to be general purpose diagramming tools, so you will need to find the database/ERD specific shapes. I would recommend [https://www.drawio.com/](https://www.drawio.com/). It is free and doesn't require a sign-up. Again you can export the images for use in your assignment.  
