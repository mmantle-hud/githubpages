...
Let's look at an example. Previously, we looked at a derived table subquery that selects each student name and their highest score from the two assessments. 
...
```
This query will return the same resultset. 
