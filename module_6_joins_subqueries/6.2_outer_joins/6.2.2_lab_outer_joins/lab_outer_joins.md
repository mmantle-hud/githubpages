...
Find all the airports that don't have any flights scheduled to depart. This is trickier, an airport might have routes assigned to them but no flights scheduled for the route. 
...
Get the routes that have no flights scheduled on 2026-07-02. 
