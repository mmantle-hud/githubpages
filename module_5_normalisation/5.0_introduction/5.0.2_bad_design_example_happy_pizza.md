---
layout: default
title: A Badly Designed Database - The Happy Pizza Company
---
...
To understand normalisation let's consider an example of a badly designed database. Then, later on this week, we will look at how normalisation can help fix some of these design flaws.
...
<pre class="mermaid">
erDiagram
    accTitle: Physical model for the Happy Pizza Company.
    accDescr: Physical model for the Happy Pizza Company.
    Employees {
        INT employee_id PK
