...
Last week we looked at selecting the student name and the overall course mark for all students in the asessment database.
...
It is important to note that regular views do not improve performance. The queries don't run any faster, they simply make queries easier to write.
...
Creating a materialised view is also easy. We simply ad the `materialized` keyword when creating the view. 
