...
## Cardinality
Another key thing about relationships is they have **cardinality**. What does this mean? **Cardinality is how many instances of one entity can be related to another entity**.  
...
## Optionality
The diagram also show **optionality**. _Optionality specifies if a relationship is optional or required (mandatory)_. 
